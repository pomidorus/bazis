    ...
    RGraph.Line = function (id)
    {
        ...
        */
        ...
        this.properties = {
            ...
            'chart.background.grid.color':  '#fff',
            'chart.background.grid.vlines': false,
            'chart.background.grid.hlines': false,
            ...
            'chart.numyticks':              10,
            'chart.linewidth':              2.5,
            'chart.colors':                 ['#444', '#0f0', '#00f', '#f0f', '#ff0', '#0ff'],
            'chart.hmargin':                0,
