    ...
    */
    RGraph.Highlight          = {};
    RGraph.tooltips           = {};
    RGraph.tooltips.padding   = '4px';
    RGraph.tooltips.font_face = 'Tahoma';
    RGraph.tooltips.font_size = '12pt';
    ...
    */
    RGraph.Tooltip = function (obj, text, x, y, idx, e)
    {
        ...
        */
        ...
        tooltipObj.style.fontWeight      = 'bold';
        tooltipObj.style.paddingTop      = '3px';
        tooltipObj.style.paddingBottom   = '3px';
        tooltipObj.style.zIndex          = 3;

        // Only apply a border if there's content
        if (RGraph.trim(text).length > 0) {
            tooltipObj.style.border             = '1px #ddd solid';
        }

        tooltipObj.style.borderRadius       = '4px';
        tooltipObj.style.MozBorderRadius    = '4px';
        tooltipObj.style.WebkitBorderRadius = '4px';
        tooltipObj.style.WebkitBoxShadow    = 'rgba(96,96,96,0.15) 0 0 3px';
        tooltipObj.style.MozBoxShadow       = 'rgba(96,96,96,0.2) 0 0 3px';
        tooltipObj.style.boxShadow          = 'rgba(96,96,96,0.15) 0 0 3px';
        ...
        tooltipObj.innerHTML                = "<div style='font-size: 11px;'>Сплачено</div><div>"+text+"</div>";
